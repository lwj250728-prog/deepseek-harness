...
export interface ApiProxy {
  ...
  llm: LlmApi
  /** The cognitive pipeline's exploration-task surface (read-only learning area). */
  cognition: CognitionApi
  /** The digital-life overview surface (chain head + trace timeline + designation). */
  life: LifeApi
...
export type { LifeApi, LifeChainHead, LifeTraceEntry } from './life.ts'
