...
export interface Experience {
  ...
  /** Epoch ms of the last review (activation refresh); absent = never reviewed. */
  readonly lastReviewedAt?: number
  /** How many reviews this experience has had (lengthens the next interval). */
...
export interface SolidifiedStrategy {
  ...
  readonly createdAt: number
  readonly updatedAt: number
  /** Epoch ms of the last drift re-verification review; absent = never reviewed. */
  readonly lastReviewedAt?: number
  /** How many reviews this strategy has had (lengthens the next interval). */
  readonly reviewCount?: number
}
