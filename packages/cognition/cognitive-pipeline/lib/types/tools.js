...
import { verifyCommandAnchor } from "./command-evidence.js";
import { verifyFileAnchor } from "./file-evidence.js";
import { findToolCallEvidence } from "./log-evidence.js";
 ...
 */
export function registerPipelineTools(ctx, service) {
        ...
        async execute(args, exec) {
            ...
            if (args.log_anchor !== undefined && exec.agent !== undefined) {
                ...
                if (!service.resolved.acceptanceCommandExecution) {
                    throw new Error('verify_claim: command anchors are disabled — enable acceptanceCommandExecution in the '
