 ...
 * thinking-mode passback. Image-capable history resolves durable attachments into ordered data-URL
 * parts; tool-result images follow their string-only tool messages in a separate user message.
