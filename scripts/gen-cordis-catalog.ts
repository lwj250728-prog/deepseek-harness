...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SimulateInput: 'cognitive-pipeline.md',
  SarTriplet: 'cognitive-pipeline.md',
  OutcomeUtility: 'cognitive-pipeline.md',
  ...
  ChainExperience: 'cognitive-pipeline.md',
  ChainPattern: 'cognitive-pipeline.md',
  ClaimAnchor: 'cognitive-pipeline.md',
  ClaimAudit: 'cognitive-pipeline.md',
  CognitionObjectKind: 'cognitive-pipeline.md',
