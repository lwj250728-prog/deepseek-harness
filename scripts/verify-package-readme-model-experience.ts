...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-cognition': { kind: 'none', reason: 'Browser-side read-only projection of the host exploration queue; the pipeline\'s inspect_memory tool and the exploration RPC own the model-facing view.' },
