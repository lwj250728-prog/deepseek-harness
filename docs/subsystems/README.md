...
| [cognitive-pipeline.md](cognitive-pipeline.md) | the DCA-PED cognition pipeline: SAR experience memory, calibrated prediction with OOD routing, feedback correction, and utility-space taxonomy rebuilds |
