...
| `ctx.cognitivePipeline` | `core` | `cognition/cognitive-pipeline` | - | - | - | Owns the SAR experience store and the hot/cold dual-loop engines: calibrated prediction with OOD routing, feedback correction, and sandbox-gated utility-space taxonomy rebuilds. |
