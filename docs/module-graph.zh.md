...
flowchart TD
  ...
  subgraph group_cognition["packages/cognition"]
    pkg_cognitive_pipeline["cognitive-pipeline"]
  end
  ...
  pkg_cognitive_pipeline --> pkg_agent
  pkg_cognitive_pipeline --> pkg_home_paths
  pkg_cognitive_pipeline --> pkg_invariants
  pkg_cognitive_pipeline --> pkg_llm
  pkg_cognitive_pipeline --> pkg_session
  pkg_cognitive_pipeline --> pkg_system_prompt
  pkg_cognitive_pipeline --> pkg_tools
...
| [`cognitive-pipeline`](../packages/cognition/cognitive-pipeline) | `cognition` | [`agent`](../packages/core/agent), [`home-paths`](../packages/util/home-paths), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`system-prompt`](../packages/core/system-prompt), [`tools`](../packages/core/tools) |
